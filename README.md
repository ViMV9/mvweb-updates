...
| Версия | Скачать |
|:-------|:--------|
| 1.0.5 (последняя) | [mvweb-price-importer-1.0.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.5.zip) |
