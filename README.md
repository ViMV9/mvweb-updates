...
| [**MVweb Price Importer**](#-mvweb-price-importer) | ![v1.0.14](https://img.shields.io/badge/v1.0.14-793ea4?style=flat-square) | Импорт каталога WooCommerce из CSV/YML/XLSX |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.0.14</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.14 (последняя) | [mvweb-price-importer-1.0.14.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.14.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.4 (последняя) | [mvweb-site-optimizer-1.0.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-site-optimizer/mvweb-site-optimizer-1.0.4.zip) |
