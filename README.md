...
| [**Smart Search**](#-mvweb-smart-search) | ![v1.4.5](https://img.shields.io/badge/v1.4.5-793ea4?style=flat-square) | Единый поиск по сайту: живая выпадашка по товарам, записям и страницам, WooCommerce, морфология, аналитика |
...
| Версия | Скачать |
|:-------|:--------|
| 1.4.5 (последняя) | [mvweb-smart-search-1.4.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.5.zip) |
