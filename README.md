...
| [**Smart Search**](#-mvweb-smart-search) | ![v1.5.9](https://img.shields.io/badge/v1.5.9-793ea4?style=flat-square) | Единый поиск по сайту: живая выпадашка по товарам, записям и страницам, WooCommerce, морфология, аналитика |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.5.9</td></tr>
<tr><td><strong>Требования</strong></td><td>WordPress 6.4+ &bull; PHP 8.0+</td></tr>
<tr><td><strong>Проверено до</strong></td><td>WordPress 7.1</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.5.9 (последняя) | [mvweb-smart-search-1.5.9.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.9.zip) |
