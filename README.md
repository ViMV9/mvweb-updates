...
<p align="center">
  <a href="#%EF%B8%8F-плагины"><img src="https://img.shields.io/badge/плагины-13-793ea4?style=for-the-badge" alt="Плагины"></a>
...
| [**MVweb Price Importer**](#-mvweb-price-importer) | ![v1.0.20](https://img.shields.io/badge/v1.0.20-793ea4?style=flat-square) | Импорт каталога WooCommerce из CSV/YML/XLSX |
...
| [**MVweb Gallery Wall**](#-mvweb-gallery-wall) | ![v1.0.1](https://img.shields.io/badge/v1.0.1-793ea4?style=flat-square) | Фотогалерея с макетами «сетка», «кирпичная кладка», «выравнивание», «бегущая лента» и лайтбоксом |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.0.20</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.20 (последняя) | [mvweb-price-importer-1.0.20.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.20.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.1 (последняя) | [mvweb-gallery-wall-1.0.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-gallery-wall/mvweb-gallery-wall-1.0.1.zip) |
