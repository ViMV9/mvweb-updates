...
| [**Price Importer**](#-mvweb-price-importer) | ![v1.4.0](https://img.shields.io/badge/v1.4.0-793ea4?style=flat-square) | Импорт каталога WooCommerce из прайс-листа или складской системы |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.4.0</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.4.0 (последняя) | [mvweb-price-importer-1.4.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.0.zip) |
