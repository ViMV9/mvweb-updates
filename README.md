...
| [**MVweb Contact Bar**](#-mvweb-contact-bar) | ![v1.0.7](https://img.shields.io/badge/v1.0.7-793ea4?style=flat-square) | Плавающая контактная панель в стиле Liquid Glass |
...
| [**MVweb Price Importer**](#-mvweb-price-importer) | ![v1.0.23](https://img.shields.io/badge/v1.0.23-793ea4?style=flat-square) | Импорт каталога WooCommerce из CSV/YML/XLSX/XLS |
...
| [**MVweb Smart Search**](#-mvweb-smart-search) | ![v1.0.3](https://img.shields.io/badge/v1.0.3-793ea4?style=flat-square) | Единый поиск по сайту: живая выпадашка по товарам, записям и страницам, WooCommerce, морфология, аналитика |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.3 (последняя) | [mvweb-smart-search-1.0.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.0.3.zip) |
