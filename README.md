...
| [**MVweb Price Importer**](#-mvweb-price-importer) | ![v1.0.9](https://img.shields.io/badge/v1.0.9-793ea4?style=flat-square) | Импорт каталога WooCommerce из CSV/YML/XLSX |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.9 (последняя) | [mvweb-price-importer-1.0.9.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.9.zip) |
