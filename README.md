...
| [**MVweb Site Optimizer**](#-mvweb-site-optimizer) | ![v1.0.5](https://img.shields.io/badge/v1.0.5-793ea4?style=flat-square) | Модульный оптимизатор WordPress: head/body cleanup, SEO, безопасность, performance, maintenance |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.0.15</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.15 (последняя) | [mvweb-price-importer-1.0.15.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.15.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.5 (последняя) | [mvweb-site-optimizer-1.0.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-site-optimizer/mvweb-site-optimizer-1.0.5.zip) |
