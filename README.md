...
| [**Local Business**](#-mvweb-local-business) | ![v1.0.1](https://img.shields.io/badge/v1.0.1-793ea4?style=flat-square) | Разметка Schema.org LocalBusiness для Google и Яндекса: адрес, часы, встраивание в граф Yoast/Rank Math без дублей, сканер главной |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.1 (последняя) | [mvweb-local-business-1.0.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-local-business/mvweb-local-business-1.0.1.zip) |
