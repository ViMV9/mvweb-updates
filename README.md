...
| [**MVweb Build Calc**](#-mvweb-build-calc) | ![v1.1.0](https://img.shields.io/badge/v1.1.0-793ea4?style=flat-square) | Библиотека строительных калькуляторов по шорткоду |
...
| Версия | Скачать |
|:-------|:--------|
| 1.1.0 (последняя) | [mvweb-build-calc-1.1.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-build-calc/mvweb-build-calc-1.1.0.zip) |
