...
| [**MVweb Price Importer**](#-mvweb-price-importer) | ![v1.0.11](https://img.shields.io/badge/v1.0.11-793ea4?style=flat-square) | Импорт каталога WooCommerce из CSV/YML/XLSX |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.0.11</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.11 (последняя) | [mvweb-price-importer-1.0.11.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.11.zip) |
