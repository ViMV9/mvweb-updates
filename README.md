...
| [**Smart Search**](#-mvweb-smart-search) | ![v1.3.0](https://img.shields.io/badge/v1.3.0-793ea4?style=flat-square) | Единый поиск по сайту: живая выпадашка по товарам, записям и страницам, WooCommerce, морфология, аналитика |
...
| Версия | Скачать |
|:-------|:--------|
| 1.3.0 (последняя) | [mvweb-smart-search-1.3.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.3.0.zip) |
