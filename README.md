...
| [**Price Importer**](#-mvweb-price-importer) | ![v1.4.7](https://img.shields.io/badge/v1.4.7-793ea4?style=flat-square) | Импорт каталога WooCommerce из прайс-листа или складской системы |
...
| [**Smart Search**](#-mvweb-smart-search) | ![v1.6.14](https://img.shields.io/badge/v1.6.14-793ea4?style=flat-square) | Единый поиск по сайту: живая выпадашка по товарам, записям и страницам, WooCommerce, морфология, аналитика |
...
| Версия | Скачать |
|:-------|:--------|
| 1.1.1 (последняя) | [mvweb-child-pages-1.1.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-child-pages/mvweb-child-pages-1.1.1.zip) |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.4.7</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.4.7 (последняя) | [mvweb-price-importer-1.4.7.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.7.zip) |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.6.14</td></tr>
<tr><td><strong>Требования</strong></td><td>WordPress 6.4+ &bull; PHP 8.0+</td></tr>
<tr><td><strong>Проверено до</strong></td><td>WordPress 7.1.1</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.6.14 (последняя) | [mvweb-smart-search-1.6.14.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.14.zip) |
