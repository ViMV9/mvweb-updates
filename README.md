...
- **Мультиязычность** &mdash; английский и русский (151 строка)
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.2 (последняя) | [mvweb-memcached-1.0.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-memcached/mvweb-memcached-1.0.2.zip) |
| 1.0.1 | [mvweb-memcached-1.0.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-memcached/mvweb-memcached-1.0.1.zip) |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.1.2</td></tr>
<tr><td><strong>Требования</strong></td><td>WordPress 6.4+ &bull; PHP 8.0+</td></tr>
...
- **Атрибуты шорткода** &mdash; id, limit, orderby, order, show_image, class, image_size, exclude, include, columns
...
| Версия | Скачать |
|:-------|:--------|
| 1.1.2 (последняя) | [mvweb-child-pages-1.1.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-child-pages/mvweb-child-pages-1.1.2.zip) |
| 1.1.1 | [mvweb-child-pages-1.1.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-child-pages/mvweb-child-pages-1.1.1.zip) |
| 1.1.0 | [mvweb-child-pages-1.1.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-child-pages/mvweb-child-pages-1.1.0.zip) |
...
> Импорт каталога товаров WooCommerce из прайс-листов CSV / YML / XLSX / XLS или из складской системы по API, с поддержкой мультискладов, обновлением остатков по расписанию и генерацией YML-фидов для Яндекс.Маркета.

<table>
<tr><td><strong>Версия</strong></td><td>1.4.8</td></tr>
<tr><td><strong>Требования</strong></td><td>WordPress 6.4+ &bull; PHP 8.0+ &bull; WooCommerce</td></tr>
<tr><td><strong>Проверено до</strong></td><td>WordPress 7.1.1</td></tr>
...
- **Товары с модификациями** &mdash; модификации складской системы становятся вариативными товарами WooCommerce со своими ценами, остатками и фото; фильтры по размеру и цвету работают сразу
- **Остатки по складам и доп. поля** &mdash; остаток только с выбранных складов (новый склад не учитывается, пока его не включат), отдельный выбор складов для карточки товара, доп. поля становятся метками и атрибутами, импорт веса и GTIN
- **Обмен заказами** &mdash; заказ магазина уходит в складскую систему заказом покупателя, а статус заказа следует за состоянием документа по расписанию; правку статуса в админке можно запретить
- **Товары без розничной цены** &mdash; товар только с оптовой ценой можно не выгружать, показать для справки с прочерком вместо цены или дать заказать по оптовой цене
- **Остатки отдельно от каталога** &mdash; обновление остатков по своему расписанию, от 5 минут, не дожидаясь полного импорта
- **Маппинг полей** &mdash; UI с 11 выпадающими списками и кнопкой автодетекта
- **Импорт категорий** &mdash; с иерархией parent/child и привязкой по внешнему ID; ветки для импорта можно выбрать до первого импорта из любого источника
...
| Версия | Скачать |
|:-------|:--------|
| 1.4.8 (последняя) | [mvweb-price-importer-1.4.8.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.8.zip) |
| 1.4.7 | [mvweb-price-importer-1.4.7.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.7.zip) |
| 1.4.6 | [mvweb-price-importer-1.4.6.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.6.zip) |
| 1.4.5 | [mvweb-price-importer-1.4.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.5.zip) |
| 1.4.4 | [mvweb-price-importer-1.4.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.4.zip) |
| 1.4.3 | [mvweb-price-importer-1.4.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.3.zip) |
| 1.4.2 | [mvweb-price-importer-1.4.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.2.zip) |
| 1.4.1 | [mvweb-price-importer-1.4.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.1.zip) |
| 1.4.0 | [mvweb-price-importer-1.4.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.4.0.zip) |
| 1.3.1 | [mvweb-price-importer-1.3.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.3.1.zip) |
| 1.3.0 | [mvweb-price-importer-1.3.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.3.0.zip) |
| 1.2.0 | [mvweb-price-importer-1.2.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.2.0.zip) |
| 1.1.0 | [mvweb-price-importer-1.1.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.1.0.zip) |
| 1.0.31 | [mvweb-price-importer-1.0.31.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.31.zip) |
| 1.0.30 | [mvweb-price-importer-1.0.30.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.30.zip) |
| 1.0.29 | [mvweb-price-importer-1.0.29.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.29.zip) |
| 1.0.28 | [mvweb-price-importer-1.0.28.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.28.zip) |
| 1.0.27 | [mvweb-price-importer-1.0.27.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.27.zip) |
| 1.0.26 | [mvweb-price-importer-1.0.26.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-price-importer/mvweb-price-importer-1.0.26.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.1.2 (последняя) | [mvweb-build-calc-1.1.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-build-calc/mvweb-build-calc-1.1.2.zip) |
| 1.1.1 | [mvweb-build-calc-1.1.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-build-calc/mvweb-build-calc-1.1.1.zip) |
...
- **Расширенные настройки** &mdash; кастомные сниппеты в `<head>`/`<body>`, нейтральные ошибки логина, cookie-баннер (152-ФЗ), отключение ревизий или лимит, заголовки `Last-Modified` / `If-Modified-Since` с поддержкой 304, passive event listeners, удаление `?ver=` у CSS/JS, обновление превью настройщика темы только по кнопке
...
- **Мультиязычность** &mdash; английский и русский (i18n ready, 558 строк)
...
| Версия | Скачать |
|:-------|:--------|
| 1.1.2 (последняя) | [mvweb-site-optimizer-1.1.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-site-optimizer/mvweb-site-optimizer-1.1.2.zip) |
| 1.1.0 | [mvweb-site-optimizer-1.1.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-site-optimizer/mvweb-site-optimizer-1.1.0.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.4 (последняя) | [mvweb-gallery-wall-1.0.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-gallery-wall/mvweb-gallery-wall-1.0.4.zip) |
| 1.0.3 | [mvweb-gallery-wall-1.0.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-gallery-wall/mvweb-gallery-wall-1.0.3.zip) |
...
<table>
<tr><td><strong>Версия</strong></td><td>1.6.15</td></tr>
<tr><td><strong>Требования</strong></td><td>WordPress 6.4+ &bull; PHP 8.0+</td></tr>
<tr><td><strong>Проверено до</strong></td><td>WordPress 7.1.2</td></tr>
...
| Версия | Скачать |
|:-------|:--------|
| 1.6.15 (последняя) | [mvweb-smart-search-1.6.15.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.15.zip) |
| 1.6.14 | [mvweb-smart-search-1.6.14.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.14.zip) |
| 1.6.13 | [mvweb-smart-search-1.6.13.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.13.zip) |
| 1.6.12 | [mvweb-smart-search-1.6.12.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.12.zip) |
| 1.6.11 | [mvweb-smart-search-1.6.11.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.11.zip) |
| 1.6.10 | [mvweb-smart-search-1.6.10.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.10.zip) |
| 1.6.9 | [mvweb-smart-search-1.6.9.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.9.zip) |
| 1.6.8 | [mvweb-smart-search-1.6.8.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.8.zip) |
| 1.6.7 | [mvweb-smart-search-1.6.7.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.7.zip) |
| 1.6.6 | [mvweb-smart-search-1.6.6.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.6.zip) |
| 1.6.5 | [mvweb-smart-search-1.6.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.5.zip) |
| 1.6.4 | [mvweb-smart-search-1.6.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.4.zip) |
| 1.6.3 | [mvweb-smart-search-1.6.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.3.zip) |
| 1.6.2 | [mvweb-smart-search-1.6.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.2.zip) |
| 1.6.1 | [mvweb-smart-search-1.6.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.1.zip) |
| 1.6.0 | [mvweb-smart-search-1.6.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.6.0.zip) |
| 1.5.13 | [mvweb-smart-search-1.5.13.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.13.zip) |
| 1.5.12 | [mvweb-smart-search-1.5.12.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.12.zip) |
| 1.5.11 | [mvweb-smart-search-1.5.11.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.11.zip) |
| 1.5.10 | [mvweb-smart-search-1.5.10.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.10.zip) |
| 1.5.9 | [mvweb-smart-search-1.5.9.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.9.zip) |
| 1.5.8 | [mvweb-smart-search-1.5.8.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.8.zip) |
| 1.5.7 | [mvweb-smart-search-1.5.7.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.7.zip) |
| 1.5.6 | [mvweb-smart-search-1.5.6.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.6.zip) |
| 1.5.5 | [mvweb-smart-search-1.5.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.5.zip) |
| 1.5.4 | [mvweb-smart-search-1.5.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.4.zip) |
| 1.5.3 | [mvweb-smart-search-1.5.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.3.zip) |
| 1.5.2 | [mvweb-smart-search-1.5.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.2.zip) |
| 1.5.1 | [mvweb-smart-search-1.5.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.1.zip) |
| 1.5.0 | [mvweb-smart-search-1.5.0.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.5.0.zip) |
| 1.4.6 | [mvweb-smart-search-1.4.6.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.6.zip) |
| 1.4.5 | [mvweb-smart-search-1.4.5.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.5.zip) |
| 1.4.4 | [mvweb-smart-search-1.4.4.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.4.zip) |
| 1.4.3 | [mvweb-smart-search-1.4.3.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.3.zip) |
| 1.4.2 | [mvweb-smart-search-1.4.2.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.2.zip) |
| 1.4.1 | [mvweb-smart-search-1.4.1.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-smart-search/mvweb-smart-search-1.4.1.zip) |
...
| Версия | Скачать |
|:-------|:--------|
| 1.0.7 (последняя) | [mvweb-object-map-1.0.7.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-object-map/mvweb-object-map-1.0.7.zip) |
| 1.0.6 | [mvweb-object-map-1.0.6.zip](https://github.com/ViMV9/mvweb-updates/raw/main/plugins/mvweb-object-map/mvweb-object-map-1.0.6.zip) |
...
- **Тема со своим выводом остатка** &mdash; для таких тем плагин отдаёт готовую метку публичной функцией
- **Мультиязычность** &mdash; английский и русский (i18n ready)
